...
const DischargeTriangle = () => {
    ...
    const onSubmit =  values => {
        ...
        setdataEntered({"y":y, "n":n,"So":So, "m1":m1, "m2":m2});

        let result={};
        result.A = AreaTriangle(y,m1,m2);
        result.P = WettedPerimeterTriangle(y,m1,m2);
        result.R = HydraulicRadiusTriangle (y,m1,m2);
        result.T = surfaceWidthTriangle(y,m1,m2);
        result.D = HydraulicDepthTriangle(y,m1,m2);
        ...
        setGoal(true);
        setTimeout(() => {
        scroller.scrollTo("resultsDischargeTriangle");
        },500)
    }

  return (
    <>
    <NavDischarge active={'triangle'}/>
    ...
    <Row md="2">
        ...
        render={({ handleSubmit, form, submitting, pristine, values }) => (
            ...
            <div className="buttons">
                <Element name="resultsDischargeTriangle">
        ...
        <Col xs={{order: 1}}  md={{order: 1}} className='p-2'>
            <Row style={{flexDirection:'column', alignItems:'center'}}>
                <img src={trianglechannel} alt="salto"  style={{width:'400px',height:'200px'}}/>
...
export default DischargeTriangle;