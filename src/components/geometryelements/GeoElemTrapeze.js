...
import { AreaTrapeze,
    WettedPerimeterTrapeze,
    HydraulicRadiusTrapeze ,
    surfaceWidthTrapeze,
    HydraulicDepthTrapeze  } from '../../modulos/GeometryElements/Trapeze';
import salto from '../../images/trapeciochannel.png';
import { Form, Field } from 'react-final-form';

import { Element } from 'react-scroll';
import { scroller } from 'react-scroll';

const GeoElemTrapeze = () => {
    ...
    const onSubmit = values => {
        ...
        setData({"y":y,"B":B,"m1":m1,"m2":m2,"A":A, "P":P, "R":R, "T":T,"D":D});
